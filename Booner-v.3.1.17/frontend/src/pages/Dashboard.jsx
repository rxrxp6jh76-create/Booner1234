                          ...
                          >
                            ...
                            <td className="px-4 py-3 text-right">
                              {(() => {
                                ...
                                if (peakProfit === undefined || peakProfit === null || isNaN(peakProfit) || peakProfit === 0) {
                                  return <span className="text-slate-600 text-xs">-</span>;
                                }
                                // Prozentualer Rückgang vom Peak-Profit zum aktuellen Profit
                                let percentDrop = null;
                                if (currentProfit !== undefined && currentProfit !== null && !isNaN(currentProfit)) {
                                  percentDrop = ((peakProfit - currentProfit) / peakProfit) * 100;
                                }
                                return (
                                  <div className="text-xs">
                                    ...
                                    {percentDrop !== null && percentDrop > 0.5 && (
